defmodule Trifle.Stats.Configuration do
  ...
  @default_granularities [:second, :minute, :hour, :day, :week, :month, :quarter, :year]
  ...
  def set_granularities(%Trifle.Stats.Configuration{} = configuration, track_granularities) do
    filtered_granularities = Enum.filter(@default_granularities, &(&1 in track_granularities))
    %{configuration | granularities: filtered_granularities}
  end
  ...
  defp calculate_granularities(%{track_granularities: track_granularities}) do
    case track_granularities do
      ...
      granularities when is_list(granularities) -> 
        # Ruby: intersection of default granularities and track_granularities, maintaining original order
        Enum.filter(@default_granularities, &(&1 in granularities))
    end
  end
